...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql+asyncpg://s3gate_svc:changeme@localhost:5432/s3gate_db"
    database_url_sync: str = "postgresql://s3gate_svc:changeme@localhost:5432/s3gate_db"
    db_schema: str = "s3gate"
    ...
    model_config = {"env_file": ".env", "env_prefix": "s3gate_".upper()}
